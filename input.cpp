...
DalitzPlotPdf* makesignalpdf(GooPdf* eff = 0){
    ...
    //Masses and Widths from PDG
    	...
    	ResonancePdf* sigma		= new Resonances::POLE("sigma",
							...
							Variable("sigma_pole_real",0.47),
							Variable("sigma_pole_img",0.22),0,PAIR_12,true);
    
	ResonancePdf* ks_800         = new Resonances::POLE("ks_800",
                                                        Variable("ks_800_real",1.),
                                                        Variable("ks_800_img",0.),
                                                        Variable("ks_800_pole_real",0.680),
                                                        Variable("ks_800_pole_img",0.300),0,PAIR_12,true);

	ResonancePdf* f0_980	= new Resonances::FLATTE("f0_980",
							Variable("f0_980_real",3.2*cos(torad(-59.3))),
							Variable("f0_980_img",3.2*sin(torad(-59.3))),
							Variable("f0_980_mass",0.965),
							Variable("f0_980_gpp",0.165),
							Variable("f0_980_gkk",0.694),PAIR_12,true);
	...
	ResonancePdf* f0_1370	= new Resonances::RBW("f0_1370",
							Variable("f0_1370_real",3.52*cos(torad(13.8))),
							Variable("f0_1370_img",3.52*cos(torad(13.8))),
							Variable("f0_1370_mass",1.4154),
							Variable("f0_1370_width",0.304),int(0),PAIR_12,true);
	...
	ResonancePdf* rho_1450	= new Resonances::RBW("rho_1450",
        ...
        ResonancePdf* ks_892	  = new Resonances::RBW("ks_892",
                                                        ...
                                                        Variable("ks_892_width",0.05),int(1),PAIR_12,true);

        ResonancePdf* ks_1430      = new Resonances::RBW("ks_1430",
                                                        Variable("ks_1430_real",1.),
                                                        Variable("ks_1430_img",0.),
                                                        Variable("ks_1430_mass",1.425),
                                                        Variable("ks_1430_width",0.270),int(1),PAIR_12,true);

        ResonancePdf* phi_1020     = new Resonances::RBW("phi_1020",
                                                        Variable("phi_1020_real",1.),
                                                        Variable("phi_1020_img",0.),
                                                        Variable("phi_1020_mass",1.019461),
                                                        Variable("phi_1020_width",0.0048),int(1),PAIR_12,true);
	...
	ResonancePdf* k2s_1430   = new Resonances::RBW("k2s_1430",
                                                        Variable("k2s_1430_real",1.),
                                                        Variable("k2s_1430_img",0.),
                                                        Variable("k2s_1430_mass",1.4256),
                                                        Variable("k2s_1430_width",0.0985),int(2),PAIR_12,true);	
